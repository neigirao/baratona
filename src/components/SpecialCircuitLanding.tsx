    ...
    <section className="space-y-6">
      ...
      {layout === 'grid' ? (
            ...
            {groupedByZone.map(([zone, items]) => (
              <div key={zone}>
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <span className="text-xs text-muted-foreground">{items.length} bares</span>
        ...
        <div className="bg-background-2 border border-border rounded-2xl overflow-hidden">
          <div className="px-4 py-3 border-b border-border flex gap-4 items-center text-[11px] uppercase tracking-wide text-muted-foreground">
